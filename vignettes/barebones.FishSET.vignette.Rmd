...
while `intdat` variables are dimension *1*, to be interacted with the distance to each alternative. Finally, users can write their own likelihoods, 
and this example is specific to the package-supplied conditional logit (`clogit`) function.
