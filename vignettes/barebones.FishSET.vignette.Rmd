...
while `intdat` variables are dimension *(number of alternatives) x 1*, to be interacted with the distance to each alternative.  
...
specific to the package-supplied conditional logit (`clogit`) function.
